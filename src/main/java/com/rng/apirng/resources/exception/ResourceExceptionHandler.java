...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authentication(AuthorizationException e, HttpServletRequest request){
		StandardError standardError = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Integridade de dados", e.getMessage(), request.getRequestURI());
